...
typedef enum {
	...
	/// \brief A drive command was overwritten and lost.
	ErrorCode_DriveCommandLost = 12,
	...
	/// \brief The FireWire card configuration is invalid: [Location]
	ErrorCode_FireWireCardConfiguration = 20,
	...
	/// \brief An error was detected in the FireWire configuration: [Location]
	ErrorCode_FireWireConfiguration = 28,
	...
	/// \brief A error occurred while performing lookahead: [Location]
	ErrorCode_LookaheadError = 49,
	...
	/// \brief Lookahead was aborted because there are no program lines remaining in the queue.
	ErrorCode_QueueBlendFail = 137,
	/// \brief The program buffered mode queue is empty.
	ErrorCode_QueueEmpty = 138,
	/// \brief A possible error was detected by lookahead. Program line: [ProgramLine]
	ErrorCode_ErrorInLookAhead = 139,
	/// \brief A FireWire card was not detected. Only virtual execution is available.
	ErrorCode_NoFireWireCard = 140,
	/// \brief No selfIDs are detected on the network. Check the FireWire cable connections.
	...
	/// \brief An error occurred while unlocking controller features.
	ErrorCode_UnlockFeaturesFailed = 153,
	...
	/// \brief The execution queue is full.
	ErrorCode_ProfileQueueFull = 160,
	/// \brief The command has not started.
	ErrorCode_CommandNotStarted = 161,
	...
	/// \brief The PLC failed to communicate with the SMC: [Location]
	ErrorCode_PLCCommunicationError = 166,
	/// \brief This action is prohibited on a PLC reserved task: [Location]
	ErrorCode_PLCRestricted = 167,
	...
	/// \brief A FireWire communication error occurred: [Location]
	ErrorCode_FireWireCommunicationsFailure = 177,
	...
	/// \brief The PLC failed to start with exit code: [ExitCode]
	ErrorCode_EclrInitializationExitCode = 184,
	/// \brief The PLCReservedTasks parameter is invalid: [Location]
	ErrorCode_PLCReservedTasks = 185,
	...
	/// \brief An error occurred when executing on the PLC reserved task: [Location]
	ErrorCode_PLCRuntimeError = 191,
	/// \brief An error occurred with Signal Log: [Location]
	ErrorCode_SignalLogError = 192,
	/// \brief An error occurred when initializing the PLC: [Location]
	ErrorCode_PLCInitializationError = 193,
	...
	/// \brief An error occurred while executing a PLC function block: [Location]
	ErrorCode_PLCFunctionBlockError = 209,
	...
	/// \brief An error occurred during fiber communication. Location: [Location]
	ErrorCode_FiberCommunicationError = 242,
	/// \brief An error occurred in the ThermoComp feature: [Location]
	ErrorCode_ThermoCompError = 243,
}	ErrorCode;

/// \brief The number of error codes.
#define ErrorCode_COUNT 244
