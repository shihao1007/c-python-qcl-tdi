...
///
/// Copyright (c) Aerotech, Inc. 2013-2016.
///
...
/// \brief Sets the PLC Shared Tags file path.
///
/// \param[in] handle A pointer to the A3200 Configuration object to use.
/// \param[in] filePath The file path of the PLC Shared Tags file to use.
/// \return TRUE on success, FALSE if an error occurred.  Call A3200GetLastError() for more information.
BOOL DLLENTRYDECLARATION A3200ConfigurationPlcSharedTagsFileSet(A3200ConfigurationHandle handle, char* filePath);

/// \brief Get the PLC Shared Tags file path.
///
/// \param[in] handle A pointer to the A3200 Configuration Object to use.
/// \param[out] filePath The buffer to store the file path in.
/// \param[in] filePathCount The size of the filePath buffer in bytes.
/// \return TRUE on success, FALSE if an error occurred.  Call A3200GetLastError() for more information.
BOOL DLLENTRYDECLARATION A3200ConfigurationPlcSharedTagsFileGet(A3200ConfigurationHandle handle, char* filePath, DWORD filePathCount);
