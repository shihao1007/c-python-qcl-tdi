...
/// \detailed The C library expects array arguments to be packed when passed in conjunction with axis masks.  For example,
/// \detailed if the axis mask indicates the command will be executed on the first and third axis, the first index of the array should
/// \detailed refer to the argument value for the first axis, and the second index of the array should refer to the argument value for the third axis.
...
/// \param[in] taskId The ID of the task on which to execute the command.
/// \param[in] axisMask The mask of axes to execute the command on
/// \param[in] OnOff Sets the break to On or Off.
/// \return TRUE on success, FALSE if an error occurred. Call A3200GetLastError() for more information.
///
/// Example usage:
///
...
/// \param[in] GainAff The acceleration feed forward gain.
/// \return TRUE on success, FALSE if an error occurred. Call A3200GetLastError() for more information.
///
/// Example usage:
///
...
/// \param[in] GainVff The velocity feed forward gain.
/// \param[in] GainPff The position feed forward gain.
/// \param[in] GainDff The acceleration feed forward gain that will be used when an axis is decelerating.
/// \return TRUE on success, FALSE if an error occurred. Call A3200GetLastError() for more information.
///
/// Example usage:
///
...
/// \brief Sends data into the PSO array.
...
/// \param[in] taskId The ID of the task on which to execute the command.
/// \param[in] Axis The axis on which to execute the command
/// \param[in] StartIndex The element of the array containing the first incremental firing distance.
...
/// \param[in] taskId The ID of the task on which to execute the command.
/// \param[in] Axis The axis on which to execute the command
/// \param[in] OutputSelect Selects the output module to which configuration commands are sent. If you do not specify this argument, or if you set the value to 0, then the first module is configured. Refer to Main Output and Auxiliary Output signals in the PSO Block Diagrams for more information.
/// \return TRUE on success, FALSE if an error occurred. Call A3200GetLastError() for more information.
///
/// Example usage:
///
...
/// \until A3200Disconnect
BOOL DLLENTRYDECLARATION A3200PSOOutputPulseExtSync(A3200Handle handle, TASKID taskId, AXISINDEX Axis, DWORD OutputSelect);
...
/// \param[in] EdgeCode An optional argument to restrict updating to one encoder direction.
/// \return TRUE on success, FALSE if an error occurred. Call A3200GetLastError() for more information.
///
/// Example usage:
///
...
/// \param[in] Axis The axis on which to execute the command
/// \param[in] WindowNumber The window to configure. The Ndrive CP, MP, QL, and Npaq MR with MP drives must be set to 1. All other drives can be set to 1 or 2.
/// \param[in] LowValue The low limit of the fixed window range.
/// \param[in] HighValue The high limit of the for fixed window range.
/// \return TRUE on success, FALSE if an error occurred. Call A3200GetLastError() for more information.
///
/// Example usage:
///
