...
typedef enum {
	...
	/// \brief Axis Extended signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_SensorFeedbackPrimary = 280,
	/// \brief Axis Extended signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_SensorFeedbackSecondary = 281,
	/// \brief Axis Extended signal. This is an internal signal, use only if directed by Aerotech.
	...
	/// \brief Axis Extended signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_DriveFeedforwardCurrent = 404,
	/// \brief Axis Extended signal. This is an internal signal, use only if directed by Aerotech.
	...
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_PositionCommandFireWire = 163,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	...
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_FireWirePacketInt32 = 186,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_FireWirePacketInt16 = 187,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_FireWirePacketInt8 = 188,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_FireWirePacketDouble = 189,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_FireWirePacketFloat = 190,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_FireWireDriveCommandCode = 191,
	...
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_FireWirePacketInfoBitValue = 210,
	...
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_FireWirePacketStreamingData = 226,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	...
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_FireWirePacketResponseInt32 = 256,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_FireWirePacketResponseInt16 = 257,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_FireWirePacketResponseInt8 = 258,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_FireWirePacketResponseDouble = 259,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_FireWirePacketResponseFloat = 260,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_FireWirePacketBit = 261,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_FireWirePacketResponseBit = 262,
	...
	/// \brief System signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_PLCBool = 211,
	/// \brief System signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_PLCByte = 212,
	/// \brief System signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_PLCWord = 213,
	/// \brief System signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_PLCDword = 214,
	/// \brief System signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_PLCSint = 215,
	/// \brief System signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_PLCInt = 216,
	/// \brief System signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_PLCDint = 217,
	/// \brief System signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_PLCUsint = 218,
	/// \brief System signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_PLCUint = 219,
	/// \brief System signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_PLCUdint = 220,
	/// \brief System signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_PLCReal = 221,
	/// \brief System signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_PLCLreal = 222,
	...
	/// \brief Task signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_DwellCommandPercentComplete = 102,
	/// \brief Task signal. This is an internal signal, use only if directed by Aerotech.
	...
	/// \brief Task signal. This item returns the value of the program line number not synchronized to the motion queue. No extra argument.
	DATASIGNAL_ProgramLineNumberNoSync = 111,
	...
	/// \brief Task signal. This item returns the identification number of the canned function pending execution on the task. This value becomes zero once the canned function is executing. No extra argument.
	...
	/// \brief Task signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_LookaheadMovesRecomputed = 279,
	...
	/// \brief Task signal. This item returns the error code that occurred during lookahead. No extra argument.
	DATASIGNAL_LookaheadErrorCode = 335,
	/// \brief Task signal. This item returns the error location that occurred during lookahead. No extra argument.
	DATASIGNAL_LookaheadErrorLocation = 336,
	/// \brief Task signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_LookaheadMovePoolIndex = 337,
	/// \brief Task signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_ActiveMovePoolIndex = 338,
	/// \brief Task signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_CoordinatedArcRadiusReciprocal = 363,
	/// \brief Task signal. This is an internal signal, use only if directed by Aerotech.
	DATASIGNAL_ActiveMoveElementAddedOrderIndex = 364,
	/// \brief Task signal. This is an internal signal, use only if directed by Aerotech.
