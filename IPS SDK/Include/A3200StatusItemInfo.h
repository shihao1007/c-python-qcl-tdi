...
typedef enum {
	...
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_PositionCommandFireWire = 163,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	...
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_FireWirePacketInt32 = 186,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_FireWirePacketInt16 = 187,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_FireWirePacketInt8 = 188,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_FireWirePacketDouble = 189,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_FireWirePacketFloat = 190,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_FireWireDriveCommandCode = 191,
	...
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_FireWirePacketInfoBitValue = 210,
	...
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_FireWirePacketStreamingData = 226,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	...
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_FireWirePacketResponseInt32 = 256,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_FireWirePacketResponseInt16 = 257,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_FireWirePacketResponseInt8 = 258,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_FireWirePacketResponseDouble = 259,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_FireWirePacketResponseFloat = 260,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_FireWirePacketBit = 261,
	/// \brief Axis signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_FireWirePacketResponseBit = 262,
	...
	/// \brief System signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_PLCBool = 211,
	/// \brief System signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_PLCByte = 212,
	/// \brief System signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_PLCWord = 213,
	/// \brief System signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_PLCDword = 214,
	/// \brief System signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_PLCSint = 215,
	/// \brief System signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_PLCInt = 216,
	/// \brief System signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_PLCDint = 217,
	/// \brief System signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_PLCUsint = 218,
	/// \brief System signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_PLCUint = 219,
	/// \brief System signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_PLCUdint = 220,
	/// \brief System signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_PLCReal = 221,
	/// \brief System signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_PLCLreal = 222,
	...
	/// \brief Task signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_DwellCommandPercentComplete = 102,
	/// \brief Task signal. This is an internal signal, use only if directed by Aerotech.
	...
	STATUSITEM_ProgramLineNumberNoSync = 111,
	...
	/// \brief Task signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_LookaheadMovesRecomputed = 279,
	...
	STATUSITEM_LookaheadErrorCode = 335,
	/// \brief Task signal. This item returns the error location that occurred during lookahead. No extra argument.
	STATUSITEM_LookaheadErrorLocation = 336,
	/// \brief Task signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_LookaheadMovePoolIndex = 337,
	/// \brief Task signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_ActiveMovePoolIndex = 338,
	/// \brief Task signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_CoordinatedArcRadiusReciprocal = 363,
	/// \brief Task signal. This is an internal signal, use only if directed by Aerotech.
	STATUSITEM_ActiveMoveElementAddedOrderIndex = 364,
	/// \brief Task signal. This is an internal signal, use only if directed by Aerotech.
